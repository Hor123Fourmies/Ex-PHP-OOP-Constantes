...
class personnage {
    ...
    // La propriété id a été modifiée pour passer de private à protected, je ne peux pas la modifier
    // ou la lire directement en-dehors de cette classe
    ...
    public function __construct()
    {
        ...
        // A chaque fois que le constructeur de ma classe personnage , je vais incrémenter
        // la propriété statique $numInstances
        // Cela va me permettre de connaitre le nombre d'instances créées
        self::$numInstances++;
        // J'utilise self pour faire référence à ma propriété statique et pas this car cette propriété
        // est associée à la classe en elle-même et pas à ses instances
    }
